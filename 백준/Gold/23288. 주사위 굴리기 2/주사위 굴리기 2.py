...
while turn < K:
    # print('turn: ', turn)
    # print('now_dice_x: ', now_dice_x, ' now_dice_y: ', now_dice_y, ' now_dir: ', now_dir)
    # print('now_dice: ', now_dice)
    # 주사위 굴러감
    ...
    # print('new_dice_x: ', new_dice_x, ' new_dice_y: ', new_dice_y, ' now_dir: ', now_dir)
